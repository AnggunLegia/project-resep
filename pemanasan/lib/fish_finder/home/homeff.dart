          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                width: 300,
                height: 150,
                child: Center(child: Text("Fish Finder")),
                decoration: BoxDecoration(
                    border: Border.all(width: 2),
                    borderRadius: BorderRadius.circular(10)),
              ),
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (BuildContext context) =>FishFinderApp2()));
              },
              child: Container(
                margin: EdgeInsets.only(top: 20, left: 30),
                width: 300,
                height: 150,
                child: Center(child: Text("Fish Finder 200")),
                decoration: BoxDecoration(
                    border: Border.all(width: 2),
                    borderRadius: BorderRadius.circular(10)),
              ),
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (BuildContext context) => Chart03()));
              },
              child: Container(
                margin: EdgeInsets.only(top: 20, left: 30),
                width: 300,
                height: 150,
                child: Center(child: Text("Fish Finder 3")),
                decoration: BoxDecoration(
                    border: Border.all(width: 2),
                    borderRadius: BorderRadius.circular(10)),
              ),
